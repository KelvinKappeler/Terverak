...
object CardEffectsDraw {
  ...
  /**
    ...
    */
  final case class DrawCard(amount: Int = 0) extends CardEffectWithoutTarget {
   ...
   */
  final case class DrawCardPerSubtype(amount: Int, subtype: CardSubtype, target: CardEffectTarget) extends CardEffectWithoutTarget {
    require(amount >= 0)
