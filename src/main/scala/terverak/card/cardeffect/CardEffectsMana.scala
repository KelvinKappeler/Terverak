...
object CardEffectsMana {
   ...
   */
  final case class AddMana(amount: Int = 0) extends CardEffectWithoutTarget {
    ...
    */
  final case class AddManaPerSubtype(amount: Int, subtype: CardSubtype, target: CardEffectTarget) extends CardEffectWithoutTarget {
    require(amount >= 0)
